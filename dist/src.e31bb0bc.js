...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"assets/js_pic.png":[function(require,module,exports) {
module.exports = "/js_pic.10d96ed1.png";
...
var TitleBlock = /*#__PURE__*/function (_Block) {
  ...
  _createClass(TitleBlock, [{
    key: "toHTML",
    value: function toHTML() {
      var _this$options$tag = this.options.tag,
...
var _js_pic = _interopRequireDefault(require("./assets/js_pic.png"));
var _blocks = require("./classes/blocks");
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
var model = [new _blocks.TitleBlock('Конструктор сайтов на Java-Script', {
  tag: 'h2',
  styles: {
...
}), new _blocks.TextBlock('Это будет целый творческий проект написанный на чистом Java-Script.', {
  styles: {
    color: '#008080',
...
}), new _blocks.ColumnsBlock(['Приложение на чистом Java-Script, без использования библиотек', 'Минимальное использование HTML', 'Java-Script - это просто и интересно', 'Научись создавать любые UI своими руками'], {
  styles: {
...
}), new _blocks.ImageBlock(_js_pic.default, {
  styles: {
    padding: '10px 0',
    display: 'flex',
...
exports.model = model;
},{"./assets/js_pic.png":"assets/js_pic.png","./classes/blocks":"classes/blocks.js"}],"classes/site.js":[function(require,module,exports) {
"use strict";
